...
// import { ServerComponentInServerModule } from "../server/test-server"; // this should break // It breaks because React knows that this is from an Server Module
// import { NotServerComponentStillInServerModule } from "../server/test-server"; // this should also break // It also breaks because React knows that this is from an Server Module, even if the component has no server-side logic
// import { AgnosticComponentInAgnosticModule } from "../pre-agnostic/test-agnostic"; // this should work // It works because React knows that this is from an Agnostic Module.
// import { ServerComponentInServerFunctionsModule } from "../server-functions/test-s-functions"; // this should break though // It breaks though because the function is not async so it can't even be verified as being as Server Function.
// import { AsyncServerComponentInServerFunctionsModule } from "../server-functions/test-s-functions"; // this should break too though // It's an infinitely loop if ServerComponentInServerFunctionsModule is commented. React treats AsyncServerComponentInServerFunctionsModule as an action, which therefore continuously calls itself (AND WAS JUST ABOUT TO BURN MY LAPTOP).
...
export function SetSelectButton({
  ...
  return (
    <>
      ...
      {/* this breaks */}
      {/* <ServerComponentInServerModule /> */}
      {/* this also breaks */}
      {/* <NotServerComponentStillInServerModule /> */}
      {/* this works */}
      {/* <AgnosticComponentInAgnosticModule /> */}
      {/* this breaks though */}
      {/* <ServerComponentInServerFunctionsModule /> */}
      {/* this breaks too though // WORSE, IT'S AN INFINITE LOOP */}
      {/* <AsyncServerComponentInServerFunctionsModule /> */}
    </>
  );
}
